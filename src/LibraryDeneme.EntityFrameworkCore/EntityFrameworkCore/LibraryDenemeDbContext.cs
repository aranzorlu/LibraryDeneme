...
public class LibraryDenemeDbContext :
    AbpDbContext<LibraryDenemeDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public LibraryDenemeDbContext(DbContextOptions<LibraryDenemeDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(LibraryDenemeConsts.DbTablePrefix + "Authors",
                LibraryDenemeConsts.DbSchema);
